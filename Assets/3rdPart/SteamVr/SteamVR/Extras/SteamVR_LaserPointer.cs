...
namespace Valve.VR.Extras
{
    public class SteamVR_LaserPointer : MonoBehaviour
    {
        ...
        public event PointerEventHandler PointerClickDn;
        ...
        public virtual void OnPointerClickDn(PointerEventArgs e)
        {
            if (PointerClickDn != null)
                PointerClickDn(this, e);
        }
